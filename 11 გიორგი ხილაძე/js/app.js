...
import { showLoader, hideLoader, displayErrorMessage, initUIElements, } from "./ui";
import { getCurrentWeather, getFiveDayForecast } from "./api";
import { processForecastData } from "./dataUtils";
import { displayCurrentWeather, displayFiveDayForecast, updateBackgroundVideo, initRenderersElements, } from "./renderers";
    ...
    async function loadWeather(city) {
        ...
        try {
            ...
            if (forecast) {
                ...
                displayFiveDayForecast(processed, weather?.sys?.sunrise, weather?.sys?.sunset);
            }
            else {
