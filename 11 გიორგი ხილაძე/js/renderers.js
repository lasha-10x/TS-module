...
import { mapWeatherConditionToVideo, getWeatherIconUrl, getRandomizedTime, } from "./dataUtils";
// ---------------- Elements ----------------
let elements;
// ---------------- Functions ----------------
...
export function displayCurrentWeather(weatherData) {
    if (!weatherData)
        return;
    const { cityNameElement, temperatureElement, feelsLikeElement, windSpeedElement, humidityElement, visibilityElement, pressureElement, sunriseElement, sunsetElement, weatherDescriptionElement, airQualityElement, uvIndexElement, } = elements;
    if (cityNameElement)
