...
const cityNameEl = document.querySelector(".city-name") as HTMLElement | null;
...
const currentTempIcon = document.querySelector(
  ".current-temp_icon"
) as HTMLImageElement | null;
const infoValues = document.querySelectorAll<HTMLElement>(
  ".main-weather-block .info-value"
);

const hourlyForecastList = document.querySelector(
  ".hourly-forecast-list"
) as HTMLElement | null;
const dailyForecastList = document.querySelector(
  ".daily-forecast-list"
) as HTMLElement | null;
...
function renderDailyForecast(daily: any[]) {
...
function updateWeatherCard(data: any) {
  ...
  const infoIcons = document.querySelectorAll<HTMLImageElement>(
    ".weather-info .info-icon"
  );
  const iconFiles = [
    "./photo/Humidity.png",
    "./photo/Wind.png",
...
// INPUT listener
if (cityInput) {
  cityInput.addEventListener("keydown", function (event: KeyboardEvent) {
    if (event.key === "Enter") {
