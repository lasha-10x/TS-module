...
const API_KEY: string = "39afbec6f14140c987263742251907";
...
const rainChance = document.querySelector<HTMLElement>(".rain-chance")!;
const weatherIcon = document.querySelector<HTMLElement>(".weather-icon svg")!;
const hourlyForecast = document.querySelector<HTMLElement>(".hourly-forecast")!;
const conditionValues =
  document.querySelectorAll<HTMLElement>(".condition-value");
const weeklyForecast = document.querySelector<HTMLElement>(".forecast-list")!;
...
function updateAirConditions(data: WeatherApiResponse): void {
...
function updateHourlyForecast(data: WeatherApiResponse): void {
...
function updateWeeklyForecast(data: WeatherApiResponse): void {
...
function createCloudyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
...
function createPartlyCloudyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
...
function createRainyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
...
function createStormyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
...
function createSnowyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
...
function createMistyIcon(): string {
  return `<svg width="40" height="40" viewBox="0 0 100 100">
