...
export const weatherContentConfig = {
    rain: {
        backgroundColor: "linear-gradient(135deg, hsl(210 80% 80%), hsl(230 70% 70%))",
        textColor: "#1e3a8a",
        icon: "🌧️",
    ...
    sunny: {
        backgroundColor: "linear-gradient(135deg, hsl(45 100% 85%), hsl(35 100% 75%))",
        textColor: "#1e3a8a",
        icon: "🔆",
        quote: "When the sun returns, it doesn't ask what you've been through — it just shines.",
        character: "sunny-character.jpg",
    },
    Snow: {
        backgroundColor: "linear-gradient(135deg, hsl(280 60% 80%), hsl(200 100% 75%), hsl(160 60% 75%))",
        textColor: "#1e3a8a",
        icon: "❄️",
    ...
    Drizzle: {
        backgroundColor: "linear-gradient(135deg, hsl(320 65% 85%), hsl(280 60% 80%))",
        textColor: "#f8fafc",
        icon: "🌦️",
    ...
    Thunderstorm: {
        ...
        textColor: "#f8fafc",
        icon: "⛈️",
        quote: "Every thunderstorm teaches us how strong silence can feel afterward.",
        character: "stormy-character.jpg",
    },
    Clouds: {
        backgroundColor: "linear-gradient(135deg, hsl(195 100% 95%), hsl(220 100% 88%))",
        textColor: "#1e3a8a",
        icon: "☁️",
...
export const getWeeklyWeatherData = async (place) => {
