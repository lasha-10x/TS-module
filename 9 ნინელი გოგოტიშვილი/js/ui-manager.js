...
export class UI {
    ...
    updateForecastDisplay(forecastData) {
        if (!forecastData || !forecastData.list || !this.forecastItemsContainer)
            return;
        const items = forecastData.list.filter((item) => item.dt_txt.includes('12:00:00') &&
